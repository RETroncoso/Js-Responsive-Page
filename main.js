...
const catalogo = [
  {
    nombre: "Mouse Kolke KMG-100",
    descripcion:
      "<ul><li>-Mouse óptico gamer</li><li>-Marca: Kolke</li><li>-Modelo: KMG-100</li><li>-Diseño ergonomico y excelente sensacion al tacto</li><li>-Puerto USB</li><li>-Cable: 35cm</li><li>-Led azul</li><li>-Botones 6D</li><li>-Hasta 2400 dpi</li><li>-Medidas: 8,3cm x 12,2cm x 4.0cm</li></ul>",
    precio: "560",
    foto: "src/m1.jpg",
  },
  {
    ...
    descripcion:
      "<ul><li>-Sensor óptico verdadero de 6,400 ppp</li><li>-Factor de forma ergonómico</li><li>-5 Botones Hyperesponse</li><li>-Hasta 220 pulgadas por segundo (IPS) / 30 G de aceleración</li><li>-Diseño ergonómico para diestros.</li><li>-Peso aproximado: 96 g</li><li>-Longitud del cable: 1,8 m</li></ul>",
    precio: "3999",
    foto: "src/m2.jpg",
  },
  {
    ...
    descripcion:
      "<ul><li>-Botones Programables: 7</li><li>-TIpo de agarre: Palm, Claw</li><li>-Orientación: Derecho</li><li>-Cable: mallado de 1.8 m</li><li>-Conexión: cableado USB</li><li>-DPI Minimo: 600</li><li>-DPI Maximo: 7200</li><li>-Peso: 107gr</li><li>-Dimensiones: 12.7×8.1×4.1cm</li></ul>",
    precio: "1599",
    foto: "src/m3.png",
  },
  {
  ...
  },
  {
    ...
    descripcion:
      "<ul><li>-Tipo de teclado: mecánico.</li><li>-Tipo de switches: Redragon Brown (táctil sin clic audible, 45 g de fuerza de actuación)</li><li>-Tamaño: compacto 60%.</li><li>-Reposamuñecas: no.</li><li>-Retroiluminado: sí, RGB Chroma.</li><li>-Cable: USB-C desmontable.</li><li>-Peso: 0,57 kg.</li><li>-Dimensiones: 29,17 x 10,17 x 3,6 cm.</li></ul>",
    precio: "4882",
    foto: "src/t1.jpg",
  },
  {
  ...
  },
  {
    ...
    descripcion:
      "<ul><li>-12 teclas multimedia</li><li>-Diseño Slim</li><li>-88 teclas retroiluminadas Led</li><li>-29 teclas Antighosting</li><li>-Cable 1,5 metros</li><li>-Compatible Windows 7 / 8 / 10 / MAC OSX, no es compatible con consola PS4.</li></ul>",
    precio: "3699",
    foto: "src/t3.jpg",
  },
  {
    ...
    descripcion:
      "<ul><li>-Tipo Mecánico</li><li>-Retroiluminación RGB</li><li>-Memoria integrada 3 perfiles</li><li>-Tipo de conexión USB de tipo C a USB de tipo A</li><li>-Distancia de recorrido de las teclas 1,8 mm</li></ul>",
    precio: "10890",
    foto: "src/t4.jpg",
  },
  {
    ...
    descripcion:
      "<ul><li>-Diámetro del altavoz: 50 mm</li><li>-Impedancia: 16 ohmios ± 15%</li><li>-Sensibilidad: 114dB ± 3dB</li><li>-Frecuencia: 20-20000Hz</li><li>-Dimensión del micrófono: 6.0 * 2.7 mm</li><li>-Sensibilidad del micrófono: -36dB +/- 1dB</li><li>-Directividad: omnidireccional</li><li>-Longitud del cable: Aprox. 2,2 m</li></ul>",
    precio: "2007",
    foto: "src/a1.jpg",
  },
  {
    ...
    descripcion:
      "<ul><li>-Respuesta de frecuencia: 20Hz - 20,000Hz</li><li>-Impedancia: 32 ohmios.</li><li>-Nivel de presión de sonido: 106 dBSPL / mW a 1kHz</li><li>-Peso: 300g</li><li>-Peso con micrófono: 315g</li><li>-Longitud y tipo de cable: cable de carga USB (1 m)</li></ul>",
    precio: "12899",
    foto: "src/a2.jpg",
  },
  {
  ...
  },
  {
    ...
    descripcion:
      "<ul><li>-Peso: 278 g</li><li>-Transductor: PRO-G 40 mm</li><li>-Respuesta de frecuencia: 20 Hz – 20 kHz</li><li>-Impedancia: 39 ohmios (pasiva), 5 kilohmios (activa)</li><li>-Sensibilidad: 87,5 dB SPL/mW</li><li>-Respuesta de frecuencia:	100 Hz – 10 kHz</li></ul>",
    precio: "7350",
    foto: "src/a4.jpg",
  },
];
